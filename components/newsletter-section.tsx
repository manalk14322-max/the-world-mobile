    ...
    <section id="newsletter" className="section py-8 sm:py-12">
      <div className="container">
        <div className="rounded-xl border border-black/10 bg-white p-6 text-center shadow-sm sm:p-8">
          <h2 className="text-2xl font-extrabold text-text sm:text-3xl">Get Exclusive European Offers</h2>
          <p className="mt-2 text-[16px] text-muted">Join our newsletter for early access to deals and new arrivals.</p>
